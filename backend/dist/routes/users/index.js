    ...
    async (request, reply) => {
      ...
      if (!existUser)
        throw fastify.httpErrors.unauthorized(
          errors_1.default.USER_NOT_FOUND_ERROR
        );
      const isCorrectPass = await (0, bcryptjs_1.compare)(
        password,
        existUser.passwordHash
      );
      if (!isCorrectPass)
        throw fastify.httpErrors.unauthorized(
          errors_1.default.WRONG_PASS_ERROR
        );
      reply.status(201);
